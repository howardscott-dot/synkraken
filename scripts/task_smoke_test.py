...
if __name__ == "__main__":
    with TemporaryDirectory() as tmp:
        ...
        updated = storage.update_task("task-1", {"status": "blocked", "priority": "high"}, "Howard", "2026-05-18T00:00:02+00:00")
        assert updated and updated["status"] == "blocked"
        commented = storage.add_task_comment("comment-1", "task-1", "operator", "Waiting on logs", "Howard", "2026-05-18T00:00:03+00:00")
